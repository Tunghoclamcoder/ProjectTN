...
var FullCalendar = (function (e) {
            ...
            e: if ("function" == typeof T) {
                if (
                    ...
                    null != h.componentWillUpdate &&
                        h.componentWillUpdate(E, h.__s, S),
    ...
    function O(e, t, r) {
        ...
        if (
            ...
            (i = e.ref) &&
                ((i.current && i.current !== e.__e) || I(i, null, t)),
            null != (i = e.__c))
        ) {
    ...
    (n.unmount = function (e) {
        ...
        (ne.prototype.render = function (e, t) {
            ...
            return (
                i && (i.__h = null), [f(p, null, t.__a ? null : e.children), i]
            );
        });
    ...
    function jn(e, t, n, r, i, s) {
        ...
        for (let t of s.pluginHooks.eventDefMemberAdders)
            Object.assign(o, t(e));
        return (
            Object.freeze(o.ui.classNames), Object.freeze(o.extendedProps), o
        );
    }
    const zn = {
        startTime: "09:00",
            ...
            (function (e) {
                ...
                t =
                    !0 === e
                        ...
                        : [];
                return (
                    (t = t.map((e) => Object.assign(Object.assign({}, zn), e))),
                    t
                );
            })(e),
            null,
    ...
    class Kn {
        ...
        splitProps(e) {
            let t = this.getKeyInfo(e),
                ...
                l = {};
            this.eventUiBuilders = ht(
                t,
                (e, t) => this.eventUiBuilders[t] || Vt(er)
            );
            for (let n in t) {
                let c = t[n],
                    d = s[n] || $n,
    ...
    class Fi extends Br {
        ...
        render() {
            ...
            let a,
                l = [];
            if (Vi(e.generatorName, n))
                n.customRenderingReplacesEl && delete o.elRef;
            else {
        ...
        triggerCustomRendering(e) {
            const { props: t, context: n } = this,
                { handleCustomRendering: r, customRenderingMetaMap: i } =
                    n.options;
            if (r) {
                ...
                !(function (e, t, n, r) {
                    ...
                    for (let r in l) {
                        let o = l[r],
                            ...
                            p = c[o.defId],
                            m = a[o.defId];
                        if (!fs(p.constraints, g, d, e.businessHours, t))
                            return !1;
    ...
    Hs.addStateEquality({
        scrollerClientWidths: pt,
        scrollerClientHeights: pt,
    });
    class Bs extends Br {
        constructor() {
            super(...arguments),
    ...
    function Vs(e) {
        ...
        return Object.assign(
            Object.assign(
                Object.assign({ date: n.toDate(t), view: e.viewApi }, r),
        ...
        updateSize() {
            ...
            if (i) {
                let s = r.getBoundingClientRect(),
                    o = n
                        ? Ee(t, ".fc-scrollgrid").getBoundingClientRect().top
                        : i.top,
    ...
    class $s extends Br {
        ...
        updateParentEl() {
            this.linkEl &&
                (this.parentEl = Ee(this.linkEl, ".fc-view-harness"));
        }
    }
    function Ks(e) {
        return e.text;
            ...
            (e) =>
                (function (e, t, n, r, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            d(i) || e.defaults.buttonText || d(ln) || e.type,
                        buttonTitleOverride:
                            u(r) || u(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            u(i) || e.defaults.buttonHint || u(ln),
                    };
                })(e, s, t, n, r)
        );
    }
    ...
    function To(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "REMOVE_EVENT_SOURCE":
                return (
                    (s = e), (o = t.sourceId), ut(s, (e) => e.sourceId !== o)
                );
            case "PREV":
            case "NEXT":
            case "CHANGE_DATE":
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        Object.assign(
                            Object.assign({}, vi(e.activeRange, t.dateEnv)),
                            { view: t.viewApi }
                        )
                    );
                },
    ...
    class Zo {
        constructor(e) {
            (this.computeOptionsData = Vt(this._computeOptionsData)),
                (this.computeCurrentViewData = Vt(
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = gn([ln, e, t]),
                ...
                l = (this.currentCalendarOptionsRefiners = Object.assign(
                    Object.assign(
                        Object.assign(
                            Object.assign(Object.assign({}, an), cn),
                            dn
                        ),
                        a.listenerRefiners
                    ),
            ...
            for (let e in s)
                s[e] === l[e] || (un[e] && un[e](s[e], l[e]))
                    ...
                    : (s[e] === this.currentCalendarOptionsInput[e] ||
                      (un[e] &&
                          un[e](s[e], this.currentCalendarOptionsInput[e]))
    ...
    function ga(e) {
        ...
        return new wi(
            Object.assign(
                Object.assign(
                    { timeZone: ln.timeZone, calendarSystem: "gregory" },
                    e
                ),
                { locale: t }
            )
    ...
    class ba {
        constructor(e) {
            (this.subjectEl = null),
                ...
                (ma += 1),
                1 === ma &&
                    window.addEventListener("touchmove", ya, { passive: !1 });
        }
        destroy() {
            this.containerEl.removeEventListener(
                ...
                (ma -= 1),
                ma ||
                    window.removeEventListener("touchmove", ya, {
                        passive: !1,
                    });
        }
        tryStart(e) {
    ...
    function ka(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && mi(e.dateSpan, t.dateSpan))
        );
    }
    function Ma(e, t) {
        let n = {};
        ...
        constructor(e) {
            super(e),
                ...
                (this.handlePointerDown = (e) => {
                    ...
                    let c =
                        n.isValidSegDownEl(t) && !Ee(t, ".fc-event-resizer");
                    r.setIgnoreMove(!c),
                        (this.isDragging =
                            c &&
                    ...
                    this.displayDrag(s, c),
                        ...
                        t ||
                            ...
                            this.dragging.setMirrorIsVisible(
                                !e ||
                                    !xe(this.subjectEl).querySelector(
                                        ".fc-event-mirror"
                                    )
                            ),
            ...
            return f(
                ...
                (o, a) =>
                    f(
                        ...
                        Boolean(
                            !a.isDisabled &&
                                (t.showDayNumber || Fs(i) || t.forceDayTop)
                        ) &&
                            f(
                                "div",
            ...
            if (c)
                for (let g of t) {
                    ...
                    b &&
                        (a.isRtl
                            ? ((E = 0),
                              (y = c.lefts[t.lastCol] - c.lefts[t.firstCol]))
                            : ((y = 0),
                              (E =
    ...
    class ml {
        ...
        computeDateTop(e, t) {
            return (
                t || (t = kt(e)),
                this.computeTimeTop(tt(e.valueOf() - t.valueOf()))
            );
        }
        computeTimeTop(e) {
            let t,
    ...
    class Ml extends Br {
        ...
        renderFgSegs(e, t, n, r, i) {
            ...
            return s.forPrint
                ? Il(e, s)
                : this.renderPositionedFgSegs(e, t, n, r, i);
        }
                ...
                f(
                    ...
                    Object.assign(
                        ...
                        this.slicer.sliceProps(e, n, null, t, s),
                        {
                            ...
                            nowDate: o,
                            nowIndicatorSegs:
                                i && this.slicer.sliceNowDate(o, t, s),
                            todayRange: a,
